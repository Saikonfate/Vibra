                        ...
                        <div class="form-container">
                            <form id="ponto-form" class="cadastro-form" action="cliente.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="number" step="0.01" id="taxaentrada-ponto" name="taxaentrada" class="cadastro-input" placeholder="Ex: 25.50 (0 se gratuito)" required>
                                </div>
                                <div class="form-row">
                        ...
                        <div class="form-container">
                            <form id="evento-form" class="cadastro-form" action="cliente.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="number" step="0.01" id="taxa-evento" name="taxaentrada" class="cadastro-input" placeholder="Ex: 50.00 (0 se gratuito)" required>
                                </div>
                                <div class="form-row">
