...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    elseif ($form_action === 'cadastrar_ponto') {
        ...
        $taxaentrada = ($taxaentrada_str !== '') ? filter_var($taxaentrada_str, FILTER_VALIDATE_FLOAT, FILTER_NULL_ON_FAILURE) : null;
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul>
            ...
            <li><a href="cliente.php">Conta & Cadastros</a></li>
            ...
            <?php endif; ?>
            <li><a href="#">Configurações (Em breve)</a></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-container">
                            <p class="password-text">
                                <a href="../RecuperarSenha/solicitar_recuperacao.php" class="password-link">Altere sua senha</a>. Aumente sua segurança.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-container">
                            <form id="cidade-form" class="cadastro-form" method="post" action="cliente.php">
                                ...
                                <div class="form-row">
                                    ...
                                    <textarea id="descricao-cidade" name="descricao" class="cadastro-input" placeholder="Breve descrição sobre a cidade..." rows="4"></textarea>
                                </div>
                                <div class="form-row">
                                    <label for="latitude-cidade" class="cadastro-label">Latitude (Opcional)</label>
                                    <input type="number" step="any" id="latitude-cidade" name="latitude" class="cadastro-input" placeholder="Ex: -7.2127">
                                </div>
                                <div class="form-row">
                                    <label for="longitude-cidade" class="cadastro-label">Longitude (Opcional)</label>
                                    <input type="number" step="any" id="longitude-cidade" name="longitude" class="cadastro-input" placeholder="Ex: -39.3132">
                                </div>
                                <div class="form-row">
                    ...
                    <div id="form-pontos" class="tab-secondary-content <?php echo ($prg_active_sub_tab === 'form-pontos') ? 'active' : ''; ?>">
                        <div class="form-container">
                            <form id="ponto-form" class="cadastro-form" action="cliente.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <label for="descricao-ponto" class="cadastro-label">Descrição do Ponto</label>
                                    <textarea id="descricao-ponto" name="descricao" class="cadastro-input" placeholder="Detalhes sobre o ponto turístico..." rows="4"></textarea>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <label for="endereco-ponto" class="cadastro-label">Endereço (Opcional)</label>
                                    <input type="text" id="endereco-ponto" name="endereco" class="cadastro-input" placeholder="Rua, Número, Bairro, CEP">
                                </div>
                                <div class="form-row">
                                    <label for="latitude-ponto" class="cadastro-label">Latitude (Opcional)</label>
                                    <input type="number" step="any" id="latitude-ponto" name="latitude" class="cadastro-input" placeholder="Ex: -7.1696">
                                </div>
                                <div class="form-row">
                                    <label for="longitude-ponto" class="cadastro-label">Longitude (Opcional)</label>
                                    <input type="number" step="any" id="longitude-ponto" name="longitude" class="cadastro-input" placeholder="Ex: -39.3246">
                                </div>
                                <div class="form-row">
                                    <label for="horario-abertura-ponto" class="cadastro-label">Horário de Abertura (Opcional)</label>
                                    <input type="time" id="horario-abertura-ponto" name="horario_abertura" class="cadastro-input">
                                </div>
                                <div class="form-row">
                                    <label for="horario-fechamento-ponto" class="cadastro-label">Horário de Fechamento (Opcional)</label>
                                    <input type="time" id="horario-fechamento-ponto" name="horario_fechamento" class="cadastro-input">
                                </div>
                                <div class="form-row">
                                    <label for="taxaentrada-ponto" class="cadastro-label">Taxa de Entrada (R$) (Opcional)</label>
                                    <input type="number" step="0.01" id="taxaentrada-ponto" name="taxaentrada" class="cadastro-input" placeholder="Ex: 25.50 (0 se gratuito)">
                                </div>
                                <div class="form-row">
                        ...
                        <div class="form-container">
                            <form id="evento-form" class="cadastro-form" action="cliente.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <textarea id="descricao-evento" name="descricao" class="cadastro-input" placeholder="Detalhes sobre o evento, atrações..." rows="4"></textarea>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <label for="taxa-evento" class="cadastro-label">Taxa de Entrada (R$) (Opcional)</label>
                                    <input type="number" step="0.01" id="taxa-evento" name="taxaentrada" class="cadastro-input" placeholder="Ex: 50.00 (0 se gratuito)">
                                </div>
                                <div class="form-row">
