...
$where_eventos = ["ec.status = 'aprovado'"];
$params_pontos = [];
$types_pontos = "";
$params_eventos = [];
$types_eventos = "";
...
// Não há filtro de data para pontos turísticos, se precisar, adicione aqui
// if (!empty($data_sql)) { /* ... */ }
...
// O filtro de estado aqui é para eventos. Você poderia associá-lo à cidade também, mas a coluna 'estado' está na tabela 'cidade'
if (!empty($filtro_estado)) {
    // Adiciona o filtro de estado, assumindo que a tabela cidade está sempre joinada
