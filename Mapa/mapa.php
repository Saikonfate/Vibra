...
<body>
  <header class="barra">
    ...
    <input type="text" placeholder="Pesquisar locais no mapa..." class="search-bar" id="map-search-bar">
    
    <button id="map-filters-btn" type="button" class="filtro-button-mapa">
        <i class="fa-solid fa-filter"></i> Categorias
    </button>
    
    <button type="button" class="user-btn" aria-label="Menu do Usuário" aria-expanded="false" aria-controls="user-sidebar">
